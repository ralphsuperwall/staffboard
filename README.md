...
사원의 정보를 데이터베이스에 입력되어 있는 내용대로 불러와 화면에 뿌려줍니다.<br>
...
(-@-.-)를 검사하고, 전화번호 또한 000-0000-0000 형태 또는 0000000000 로만 입력할 수 있도록 설정합니다.<br>
...
데이터베이스에 저장된 사원 리스트를 엑셀 파일로 다운로드 합니다.<br>
...
Quartz 스케줄링을 통해서 정기적인 이벤트 - 배치 프로그램을 실행할 수 있습니다. 해당 프로젝트에서는 이메일이 정해진 시간마다 자동으로 이메일이 전송되도록 합니다.<br>
